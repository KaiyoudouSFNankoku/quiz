...
marker01.addEventListener('markerFound', () => {
	setButtonState(ab1, true); // ボタンを活性化
  });
marker01.addEventListener('markerLost', () => {
	setButtonState(ab1, false); // ボタンを非活性化
  });
...
function correctOnHover(element) {
	...
	timer = setTimeout(function () {
		score += 10; // スコアを10増加
		updateScoreDisplay(); // スコアの表示を更新
		correctAudio.play(); // 正解音を再生
